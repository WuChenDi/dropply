...
![Upload Demo](assets/droply-upload-demo.gif)

### Retrieve Files (10 seconds)  
![Retrieve Demo](assets/droply-retrieve-demo.gif)
...
cp droply-backend/wrangler.jsonc.template droply-backend/wrangler.jsonc
cp droply-frontend/.env.local.template droply-frontend/.env.local
```
...
├── assets/                        # Demo assets
│   ├── droply-upload-demo.gif
│   └── droply-retrieve-demo.gif
│
├── droply-backend/          # Cloudflare Workers API
│   ├── src/
...
│
├── droply-frontend/         # Next.js frontend
│   ├── src/
